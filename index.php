            ...
            <div class="inner-wrap" id="signup">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="content">
                            ...
                            <input type="text" class="fill" name="Full Name" placeholder="Type Your Full Name" required><br>
                            <label for="Email" class="label">Email:</label><br>
                            <input type="email" class="fill" name="email" placeholder="Type Your Email" required><br>
                            <label for="Password" class="label">Password:</label><br>
                            <input type="password" class="fill" name="password" placeholder="Enter Your Password" maxlength="13"><br>
                            <label for="confirm-password" class="label">Confirm Password:</label>
                            <input type="password" class="fill" name="confirm Password" placeholder="Confirm Password" maxlength="13"><br>
                            <input type="submit" class="btn" name="SignUp submit" value="Create Account">
                            ...
                            if (isset($_POST['SignUp_submit'])) {
								...
								$pw = $_POST['password'];
									...
									$sql = "SELECT * from team_elite WHERE user_id = '$email'";
